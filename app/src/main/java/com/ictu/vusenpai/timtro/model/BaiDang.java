...
public class BaiDang implements Parcelable {
    ...
    public BaiDang(String tieuDe, String diaChi, int dienTich, ArrayList<String> anhFeeback, int gia, String idBaiDang, String idUser, String time, String sdt) {
        this.tieuDe = tieuDe;
        this.diaChi = diaChi;
